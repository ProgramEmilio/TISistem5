...
<body>
    ...
    <h1 class="titulo">Editar Problema</h1>
    <br>
    <?php
    ...
    if (isset($_GET['Id_problema'])) {
        ...
        $Id_problema = $conn->real_escape_string($_GET['Id_problema']);
    ...
    WHERE Id_problema = '$Id_problema'";
        ...
        ?>
                <form class="form_edi_departamento" action="Editar_P.php" method="POST" enctype="multipart/form-data">             
                    
                    <label for="problema">Problema:</label><br>
                    <input type="text" id="problema" name="problema" value="<?php echo $row['problema']; ?>" required><br><br>
                    
                    <label for="causa_raiz">Causa Raiz:</label><br>
                    <input type="text" id="causa_raiz" name="causa_raiz" value="<?php echo $row['causa_raiz']; ?>" required><br><br>
                    
                    <label for="error_conocido">Error Conocido:</label><br>
                    <input type="text" id="error_conocido" name="error_conocido" value="<?php echo $row['error_conocido']; ?>" required><br><br>
                    
                    <label for="solucion">Solucion:</label><br>
                    <input type="text" id="solucion" name="solucion" value="<?php echo $row['solucion']; ?>" required><br><br>
                    
                    <label for="nom_usuario">Usuario:</label><br>
                    <input type="text" id="nom_usuario" name="nom_usuario" value="<?php echo $row['nom_usuario'] . ' ' . $row['apellido_usu']; ?>" required><br><br>
                    <input type="hidden" name="Id_problema" value="<?php echo $row['Id_problema']; ?>">
                    <input type="hidden" name="Id_usuario" value="<?php echo $row['id_usuario']; ?>">
                    <input type="submit" value="Modificar Problema">
                </form>
            <?php
                    }
                } else {
            ...
            $conn->close();
            ?> 
	<a href="problema.php" class="regresar">Regresar</a>
