...
<body>
    ...
    $sql = "SELECT edificio.Id_edificio, departamento.nombre AS nombre_departamento
        FROM edificio
        JOIN departamento ON edificio.Id_departamento = departamento.Id_departamento
        ORDER BY edificio.Id_edificio ASC";
	...
	while ($fila = $result->fetch_assoc()) {
		echo "<tr>";
        echo "<th scope='row'>".$fila['Id_edificio']."</th>"; 
        echo "<td>". $fila['nombre_departamento']."</td>";
        echo "<td><a href='Modificar/Modificar_Edificios.php?Id_edificio=".$fila['Id_edificio']."' class='editar'> Editar </td>";
        echo "<td><a href='Eliminar/Eliminar_Edificios.php?Id_edificio=".$fila['Id_edificio']."'>Eliminar</a></td>";
        echo "</tr>";
	}
	echo "</tbody>";
	echo "</table>";
?>
    ...
    <!-- FORM DE AGREGAR -->
    <form id="form_reg_edificio" class="form_reg_edificio" action="Registrar/Registrar_Edificio.php" method="POST" enctype="multipart/form-data" style="display: none;">
    
        <label for="Id_edificio">Edificio:</label><br>
        <input type="text" id="Id_edificio" name="Id_edificio" required><br><br>
        ...
        <input type="submit" value="Registrar Edificio">
    </form>
    ...
    <script>
    function toggleForm() {
        var form = document.getElementById("form_reg_edificio");
