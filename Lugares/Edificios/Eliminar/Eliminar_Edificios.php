...
<body>
    ...
    <h1 class="titulo">Elminar Edificio</h1>
    <?php
    include("../../../BD/ConexionBD.php");

    if (isset($_GET['Id_edificio']) && !empty($_GET['Id_edificio'])) {
        $Id_edificio = mysqli_real_escape_string($conn, $_GET['Id_edificio']);
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='info'>";
            echo "<p>Edificio: " . $fila['Id_edificio'] . "</p>";
            echo "<p>Departamento: " . $fila['nombre_departamento'] . "</p>";

            echo "<form class='Eliminar_Edificio' action='Eliminar_E.php' method='POST'>";
            echo "<input type='hidden' name='Id_edificio' value='" . $fila['Id_edificio'] . "'>";
            echo "<input type='submit' value='Eliminar Edificio'>";
            echo "</form>";
            echo "</div>";
        } else {
...
?>
    ...
    <p><a href='../Edificio.php' class="regresar">Regresar</a></p>
</body>
