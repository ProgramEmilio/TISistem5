...
<body>
    ...
    <h1 class="titulo">Modificar Departamento</h1>
    <?php
    // Verifica si se ha enviado el ID del salon
    if (isset($_GET['Id_departamento'])) {

        // Obtiene el ID del usuario de la URL y escapa el valor
        $Id_departamento = $conn->real_escape_string($_GET['Id_departamento']);
        ...
        ?>
                <form class="form_edi_departamento" action="Editar_D.php" method="POST" enctype="multipart/form-data">             
                    
                    <label for="Id_departamento">Departamento:</label><br>
                    <input type="text" id="Id_departamento" name="Id_departamento" value="<?php echo $row['Id_departamento']; ?>" required><br><br>
                    ...
                    <input type="text" id="J_departamento" name="J_departamento" value="<?php echo $row['J_departamento']; ?>" required><br><br>
                    
                    <input type="submit" value="Modificar Edificio">
                </form>

                <a href="../Departamentos.php" class="regresar">Regresar</a> 
