...
<body>
    ...
    <h1 class="titulo">Elminar Departamentos</h1>
    <?php
    include("../../../BD/ConexionBD.php");

    if (isset($_GET['Id_departamento']) && !empty($_GET['Id_departamento'])) {
        $Id_departamento = mysqli_real_escape_string($conn, $_GET['Id_departamento']);
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='info'>";
            echo "<p>Departamento: " . $fila['Id_departamento'] . "</p>";
            echo "<p>Nombre: " . $fila['nombre'] . "</p>";
            echo "<p>Jefe Departamento: " . $fila['J_departamento'] . "</p>";

            echo "<form class='Eliminar_Departamento' action='Eliminar_D.php' method='POST'>";
            echo "<input type='hidden' name='Id_departamento' value='" . $fila['Id_departamento'] . "'>";
            echo "<input type='submit' value='Eliminar Departamento'>";
            echo "</form>";
            echo "</div>";
        } else {
            echo "<p>No se encontró el departamento.</p>";
        }
    } else {
        echo "<p>No se proporcionó un ID no válido.</p>";
    }
...
?>
    ...
    <p><a href='../Departamentos.php' class="regresar">Regresar</a></p>
</body>
