...
<body>
    ...
    if (isset($_GET['Id_salon'])) {
        ...
        ?>
                <form class="form_edi_salon" action="Editar_S.php" method="POST" enctype="multipart/form-data">             
                    
                    <label for="Id_salon">Salon:</label><br>
                    <input type="text" id="Id_salon" name="Id_salon" value="<?php echo $row['Id_salon']; ?>" required><br><br>
                ...
                <label for="descripcion">Descripción:</label><br>
                    ...
                    <input type="submit" value="Modificar Salon">
                </form>

                <a href="../salon.php" class="regresar">Regresar</a> 
