...
<head>
    ...
    <title class="titulo">Editar Usuario</title>
</head>
...
<?php
	...
	while ($fila=$result->fetch_assoc()) {
		...
		echo "<td><a href='Modificar.php?Id_usuario=".$fila['Id_usuario']."'> Editar </td>";
		//echo "<td><a href='Eliminar/Eliminar_Usuario.php?Id_usuario=".$fila['Id_usuario']."'>Eliminar</a></td>";
		echo "</tr>";
	}
	echo "</table>";
	?>
