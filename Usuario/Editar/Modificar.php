            ...
            <?php if ($Usu['Id_Utipo'] == 1 || $Usu['Id_Utipo'] == 4): ?>
                ...
                <li><a href="../Usuario.php">Usuarios</a>
                    <ul class="submenu">
                        ...
                        <li><a href="Editar_Usuario.php">Modificar</a></li>
...
<body>
    ...
    <h1 class="titulo">Modificación de Usuario</h1>
    <?php
    ...
    if (isset($_GET['Id_usuario'])) {
        ...
        // Consulta SQL para seleccionar solo el usuario con el ID especificado
        ...
        ?>
                <form class="form_edi_usuario" action="Editar_U.php" method="POST" enctype="multipart/form-data">             
                    <input type="hidden" name="Id_usuario" value="<?php echo $row['Id_usuario']; ?>"><br>
                    ...
                    <input type="password" id="contraseña" name="contraseña" value="<?php echo $row['contraseña']; ?>" required><br><br>
                ...
                <a href="Editar_Usuario.php" class="regresar">Regresar</a> 
